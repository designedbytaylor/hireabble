...
function EmailNotificationSettings({ token, userRole }) {
  ...
  const items = isRecruiter ? [
    ...
    { key: 'weekly_digest', label: 'Weekly hiring report', desc: 'Weekly summary of applications, connections, and pipeline stats' },
    ...
    { key: 'weekly_digest', label: 'Weekly market report', desc: 'Weekly summary of new jobs, connections, and profile views' },
    { key: 'marketing_emails_opt_in', label: 'Marketing & promotions', desc: 'Occasional updates, tips, and promotional offers' },
  ];
              ...
              <div className="flex items-center gap-4">
                <div className="relative">
                  <img
                    ...
                    src={getPhotoUrl(user?.company_logo, user?.company || user?.name || 'company')}
                    alt="Company Logo"
                    className="w-16 h-16 rounded-xl border-2 border-border object-cover bg-background"
                    onError={handleImgError(user?.company || user?.name || 'company')}
                  />
                  <button
